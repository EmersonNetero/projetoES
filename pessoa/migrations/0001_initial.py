# Generated by Django 3.2.3 on 2021-07-03 21:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fotoPerfil', models.FileField(blank=True, null=True, upload_to='static/fotos/', verbose_name='Foto do Perfil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacao', models.TextField(blank=True, max_length=300, null=True, verbose_name='Observação')),
                ('valor', models.DecimalField(decimal_places=2, max_digits=19, verbose_name='Valor *')),
                ('reaçizado', models.BooleanField(default=False, null=True)),
                ('fk_agendamento', models.ForeignKey(db_column='pk_agendamento', on_delete=django.db.models.deletion.PROTECT, to='pessoa.agendamento', verbose_name='Tipo de Procedimento *')),
                ('fk_paciente', models.ForeignKey(db_column='pk_paciente', on_delete=django.db.models.deletion.PROTECT, to='pessoa.paciente', verbose_name='Paciente *')),
